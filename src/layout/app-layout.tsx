...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'hr-company-representative', 'organization-representative', 'interviewer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Resume', path: '/resumes', entity: 'resume', service: AccessServiceEnum.PROJECT, icon: FiFileText },
